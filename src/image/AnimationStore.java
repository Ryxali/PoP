...
public enum AnimationStore implements Loadable {
	...
	PART_STICK(ImageStore.CRAFTING_PART_STICK_ITEM, 1, 250),
	PART_DUST(ImageStore.CRAFTING_PART_DUST_ITEM, 1, 250),
	PART_VACCUM(ImageStore.CRAFTING_PART_STICK_ITEM, 1, 250),
	PART_COG(ImageStore.CRAFTING_PART_COG_ITEM, 1, 250);
